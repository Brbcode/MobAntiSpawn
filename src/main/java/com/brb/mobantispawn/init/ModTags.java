package com.brb.mobantispawn.init;

import com.brb.mobantispawn.BrbMod;
...
public class ModTags {
    public static final class Blocks {
        ...
        // Default namespace is mod ID, so this one will be "mobantispawn:example_block"
    ...
    public static final class Items {
        // Item tags work the same way as block tags, so this is "mobantispawn:example_item"
